    ...
    <div className="relative min-h-[440px] overflow-hidden rounded-[22px] bg-charcoal text-paper">
      ...
      <svg
        ...
        <g stroke="#F7F4EE" strokeWidth="1.4" fill="none" opacity="0.76">
          <path data-values-visual="building-line" d="M78 396h385" />
          <path data-values-visual="building-line" d="M96 396V122h170v274" />
          <path data-values-visual="building-line" d="M304 396V174h140v222" />

          <path
            data-values-visual="building-line"
            d="M118 96h126l22 26H96l22-26z"
          />
          <path
            data-values-visual="building-line"
            d="M346 150h74l24 24H304l22-24z"
          />
        </g>

        <g data-values-visual="people" fill="#F7F4EE">
        ...
        <g stroke="#E8262A" strokeWidth="3" fill="none">
          <path data-values-visual="red-line" d="M218 278h86l30 26" />
          <path data-values-visual="red-line" d="M218 300 l30 26 h86" />
          <circle
            data-values-visual="red-node"
            cx="334"
            cy="304"
            r="7"
            fill="#E8262A"
